...
CAMLprim value
ml_interface_read (value ml_interface, value ml_buffer, value ml_len)
{
...
CAMLprim value
ml_interface_write (value ml_interface, value ml_buffer, value ml_len)
{
        CAMLparam3 (ml_interface, ml_buffer, ml_len);
        CAMLlocal1 (ml_result);
...
CAMLprim value
ml_interface_set_server_features (value interface, value v)
{
        CAMLparam2 (interface, v);
        struct xenstore_domain_interface *intf =
                GET_C_STRUCT (interface)->addr;
...
CAMLprim value
ml_interface_get_server_features (value interface)
{
...
CAMLprim value
ml_interface_close (value interface)
{
        CAMLparam1 (interface);
        struct xenstore_domain_interface *intf =
                GET_C_STRUCT (interface)->addr;
